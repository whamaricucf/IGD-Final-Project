...
{
    [SerializeField]
    string wepName; // the name of the weapon
    float area, spd, duration, cd, projInterval, hitDelay, knockback, critChance, critMulti;
    ...
    int maxLvl, rarity, baseDMG, amount, pierce, limit;
